...
urlpatterns = [
    ...
    path('playbooks/<int:playbook_id>/versions/<int:version_id>/rollback/', views.playbook_rollback, name='playbook_rollback'),
    ...
    path('api/metrics/summary', views.metrics_summary, name='metrics_summary'),
